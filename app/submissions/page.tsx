...
export default async function Submissions(){const user=await requireChatGPTUser("/submissions");return <><AtlasHeader/><main className="shell"><PageTitle eyebrow="YOUR CONTRIBUTIONS" title="我的创作" text="管理地图与 Mod、编辑资料和发布码、查看审核意见。"/><CreationTabs maps={<>{isAdmin(user)&&<CreatorFeatured/>}<SubmissionDashboard/></>} mods={<ModDashboard/>}/></main><AtlasFooter/></>}
