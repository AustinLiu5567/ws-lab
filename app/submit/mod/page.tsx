    ...
    <>
      ...
      <main className="shell">
        ...
        <div className="english-only">
          <PageTitle
            eyebrow="CONTRIBUTE / SUBMIT A MOD"
            title="Share your mod. Make new ways to play discoverable."
            text="Provide real codes, clear instructions, and permission details. Approved submissions join the community library."
          />
        </div>
        <nav className="creation-switch" aria-label="投稿类型 / Submission type">
          <Link href="/submit">
            <Bilingual zh="提交地图" en="Submit a map" />
          </Link>
          <Link href="/submit/mod" aria-current="page">
            <Bilingual zh="提交 Mod" en="Submit a mod" />
          </Link>
        </nav>
